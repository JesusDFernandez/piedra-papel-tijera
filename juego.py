...
# Images to show
image1 = cv2.imread("comienzo.jpg")
image2 = cv2.imread("elige.jpg")
image_winner = cv2.imread("ganaste.jpg")
image_tie = cv2.imread("empate.jpg")
image_loser = cv2.imread("perdiste.jpg")
image_piedra = cv2.imread("piedra.jpg")
image_papel = cv2.imread("papel.jpg")
image_tijera = cv2.imread("tijera.jpg")
image_blanco = cv2.imread("blanco.jpg")

image=[image_piedra,image_papel,image_tijera]
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            fingers = fingers_up_down(
                results, thumb_points, palm_points, fingertips_points, finger_base_points)
        ...
        n_image = cv2.hconcat([imAux, imAux2, frame])
        cv2.imshow("Juego", n_image)
